    ...
    if (detail == 1) {
      ...
      if (detail == 2) {
        ...
        if (options.shouldShowLinks) {
          ...
          html += ' <a href="https://my102.iit.edu/banr/bwckctlg.p_disp_course_detail?cat_term_in=201620&subj_code_in=' + course.name.split(' ')[0] + '&crse_numb_in=' +course.name.split(' ')[1] + '" target="_blank" title="Opens in a new window">View in course catalog</a>';
          html += '</p>';
        }
        html += '<p>' + description + '</p>';
